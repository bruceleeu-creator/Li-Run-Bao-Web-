...
- 线上版本：http://49.232.160.7:8082 与 GitHub main 同步——2026-09-07 起 = `2475d02`（v1.4.0 + v30 Key 内存化 + v31 AI 出题锚定加固 + v32 诊断聚焦与出题规则优化），CI 全绿后自动部署；看板 8081 同机部署
